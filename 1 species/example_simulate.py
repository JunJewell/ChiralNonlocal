...
parameter_string = "kernel=%s \nU=%.10f \nangle=%.10f \nrho=%.10f \nxi=%.10f \nmu=%.10f \nL_x=%.10f \nL_y=%.10f \nmesh_points_x=%d \nmesh_points_y=%d \ninitial_time=%.10f \nfinal_time=%.10f \nRNG_Seed=%d" %(kernel_name, U, angle, rho, xi, mu, L_x, L_y, mesh_points_x, mesh_points_y, time_span[0], time_span[1], RNG_seed)
...
system = nonlocal_react_advect_diffuse_system(U, angle, rho, xi, mu, L_x, L_y, kernel_name,
...
plotter = plotter(angle=angle, rho=rho, U=U, mu=mu, xi=xi, kernel_name=kernel_name,
                       L_x=L_x, L_y=L_y, mesh_points_x=mesh_points_x,
                       mesh_points_y=mesh_points_y, solution_y=solution.y,
                       solution_t=solution.t, folder_tag = folder_tag, file_tag=r"",
